...
![](https://img.gpt-vip.top/20190331203233.png?imageMogr2/format/webp)
...
光猫设置参考[光猫改造 篇三：百卓 GP1700 进阶设置 - 端口映射](https://gpt-vip.top/posts/2018-06-08-Baizhuo_GP1700.html)。

## OpenVPN 配置

内网穿透完成后，开始 OpenVPN 配置。梅林路由器进入「高级设置」→「VPN」→「虚拟专用网（VPN）服务器」，开启路由器自带的 OpenVPN。

![](https://img.gpt-vip.top/20190331200921.png?imageMogr2/format/webp)
...
![](https://img.gpt-vip.top/20190331202017.png?imageMogr2/format/webp)
