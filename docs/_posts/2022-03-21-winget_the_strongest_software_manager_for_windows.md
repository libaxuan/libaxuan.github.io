...
![](https://img.gpt-vip.top/2022-05-05-17-13-24.png?imageMogr2/format/webp)
...
![](https://img.gpt-vip.top/2022-05-05-17-13-45.png?imageMogr2/format/webp)
...
![](https://img.gpt-vip.top/2022-05-05-17-14-00.png?imageMogr2/format/webp)
...
![](https://img.gpt-vip.top/2022-05-05-17-14-23.png?imageMogr2/format/webp)

安装中会要求接受协议，点 Y 确认即可。

![](https://img.gpt-vip.top/2022-05-05-17-14-35.png?imageMogr2/format/webp)
...
![](https://img.gpt-vip.top/2022-05-05-17-14-50.png?imageMogr2/format/webp)

winstall 的应用搜索继承了 winget 的问题，部分国产软件不支持中文搜索，比如「坚果云」只支持英文名称「Nutstore」。希望这一问题，可以随着国内用户群增多而被解决。

![winget 搜索](https://img.gpt-vip.top/2022-05-05-17-15-09.png?imageMogr2/format/webp)

![winstall 搜索](https://img.gpt-vip.top/2022-05-05-17-15-37.png?imageMogr2/format/webp)

winstall 页面选好程序后，导出自动生成的批量安装命令，并在命令提示符 (cmd) 中执行，系统将自动下载并静默配置程序。

![](https://img.gpt-vip.top/2022-05-05-17-15-55.png?imageMogr2/format/webp)
...
另一个可能是 Internet 选项的 TLS 版本设置过低，开启 TLS 1.2 即可恢复，具体操作查看 [Windows 应用商店 (Microsoft store) 打不开？](https://gpt-vip.top/posts/2022-02-19-microsoft_store_fixed.html#解决方法)。
