...
虽然与 Stable Diffusion 同样归属 AI 工具，但是 Whisper 安装非常简单。只需在终端输入两行代码，安装 Whisper 和 FFmpeg，就可以开始使用了。如你不清楚如何安装 FFmpeg，可以参考 [FFmpeg 配置步骤](https://gpt-vip.top/posts/2022-11-03-ffmpeg_screen_recording.html#%E9%85%8D%E7%BD%AE-ffmpeg)。这部分我不多做赘述，具体可以参考 [Whisper 官方文档](https://github.com/openai/whisper)。
...
![](https://img.gpt-vip.top/2022-11-18-09-25-29.png "whisper 命令")
...
![](https://img.gpt-vip.top/2022-11-18-23-21-25.png "ATP Podcast Search 搜索界面")
