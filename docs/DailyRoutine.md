...
5AM Club 是我的[高效早晨方案](https://gpt-vip.top/posts/2023-03-31-efficient_morning_5am_club.html)：
...
为了更好地监督自己，我制定了一套[自我监控方案](https://gpt-vip.top/posts/2022-05-22-surveillance_video_for_myself.html)，以记录自己的私人工作状态。

1. 开机（8 点）启动录屏命令，并检测护眼提醒是否开启。可参考 [FFmpeg 录屏方案](https://gpt-vip.top/posts/2022-11-03-ffmpeg_screen_recording.html)来修改命令：
...
![](https://img.gpt-vip.top/2022-11-02-11-02-43.png "GTD 任务转移到清单")

从 GTD 流程角度，执行任务和计划。

![](https://iili.io/JnQectn.png "GTD 流程步骤")
